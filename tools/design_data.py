...
SHELF_UNITS = [
    ...
    # ---- 变频 ----
    ("DCONV-01",      "下变频器", "变频", ["L", "S", "C", "X", "Ku", "Ka"], 4, 0.5, 4.0, dict(G=-2, NF=8), "镜像抑制 >60dBc"),
    ("UCONV-01",      "上变频器", "变频", ["L", "S", "C", "X", "Ku", "Ka"], 4, 0.5, 4.0, dict(G=-2), ""),
    ("LO-SRC-01",     "频率源/本振", "变频", ["*"], 4, 1.0, 8.0, dict(Lφ=-95), "相位噪声 −95dBc/Hz@10kHz"),
    # ---- IMUX/OMUX ----
    ("IMUX-01",       "输入多工器", "多工器", ["L", "S", "C", "X", "Ku", "Ka"], 4, 2.0, 0, dict(N=8, IL=1.5), "8 通道"),
    ("OMUX-01",       "输出多工器", "多工器", ["L", "S", "C", "X", "Ku", "Ka"], 4, 3.5, 0, dict(N=8, IL=1.8), "8 通道，插损 1.8dB"),
    # ---- 功放 ----
